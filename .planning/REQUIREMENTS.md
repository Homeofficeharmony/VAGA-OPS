...
- [ ] **CVAR-01**: User sees different tips each day, drawn from an expanded pool of 20+ per state
...
- [ ] **CVAR-04**: User sees task checklist items that rotate by time-of-day context (morning/afternoon/evening)

### Data Visualization

- [ ] **DVIZ-01**: User sees a visual before/after activation comparison in the post-reset check-in
...
- [ ] **STUX-02**: User can enter an ambient mode (atmosphere + audio without a structured session)
